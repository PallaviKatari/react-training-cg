...
const UsingFetch = () => {
  ...
  const filteredUsers = products.filter((user) => user.category.startsWith("m"));
  return (
      ...
      (
        ...
        <div className="row">
          ...
          filteredUsers.map((product) => 
            ...
            <div className="col-md-3" key={product.id}  style={{border:'inset',width:250,borderRadius:10,marginLeft:50,marginBottom:30}}>
