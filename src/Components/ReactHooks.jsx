    ...
    return (
        <div>
            ...
            <input
                ...
                style={{ marginTop: 30, width: 100, marginLeft: 100, borderStyle: 'dashed', borderColor: 'black' }}></input>
        </div>
    );
}
...
function Context() {
    const [user] = React.useState({ name: "John" ,age:25});
    const [emp]=React.useState({ empName: "Peter",age:30 });

    return (
        <>
         <UserContext.Provider value={user}>
            <UserContext1.Provider value={emp}>
                <Main />
...
const Header = () => {
    ...
    return <>
        ...
        <h1 style={{ marginTop: 20 }}>Age: {user.age}</h1>
    </>;
}
const Header1 = () => {
    ...
    return <>
        <h1>React useContext Header1</h1>
        <h1 style={{ marginTop: 20 }}>Welcome, {user.empName}!</h1>
        <h1 style={{ marginTop: 20 }}>Age: {user.age}</h1>
    </>;
}